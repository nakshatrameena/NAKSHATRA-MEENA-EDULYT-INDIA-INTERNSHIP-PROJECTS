...
LINES TERMINATED BY '\n'
IGNORE 1 ROWS
(sl_no, customer_id, month, @amount, @extra)
...
-- INTO OUTPUT FILE RAYPENT_CLEANED
SELECT *
FROM repayment
INTO OUTFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/Repayment_Cleaned.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\n';

-- HIGH_VALUE_REPAYMENT
SELECT *
FROM repayment
WHERE amount > 50000
INTO OUTFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/high_value_repayment.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\n';

-- REPAYMENT_WITH_HEADER
SELECT 'sl_no','customer_id','month','amount'
UNION ALL
SELECT sl_no, customer_id, month, amount
FROM repayment
INTO OUTFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/Repayment_With_Header.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\n';
